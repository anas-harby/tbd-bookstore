...
public class ModifyBookDialogControl extends JFXDialog {
    ...
    public ModifyBookDialogControl() {
        loadFxml("/com/tbdbookstore/view/fxml/manager/ModifyBookDialog.fxml");
        dialogFields = new ArrayList<>(Arrays.asList(titleField, authorsField,
